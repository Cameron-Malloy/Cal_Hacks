        ...
        >
          <GlassCard glow>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="bg-input-background border-primary/20 focus:border-primary pl-10"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="bg-input-background border-primary/20 focus:border-primary pl-10 pr-10"
                    required
                  />
                  <button
                    type="button"
              ...
              <Button
                type="submit"
                className="w-full bg-gradient-to-r from-primary to-secondary hover:from-primary/80 hover:to-secondary/80 text-white shadow-[0_0_20px_rgba(167,139,250,0.4)]"
              >
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              ...
              <Button
                ...
                variant="outline"
                className="border-primary/20 hover:bg-primary/10"
                onClick={() => onLogin("github-user@example.com")}
              >
